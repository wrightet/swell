            ...
            <div>
                <div className="Splash">
                    ...
                    <div className="Text-wrapper">
                        <p>Swell is an app for surfers by surfers that allows you to check local weather and tide conditions, find local surf spots, log your surf sessions, connect with other surfers, and help you plan
